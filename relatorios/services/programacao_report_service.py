...
def _build_non_performed_groups(unidade_id: int, data_inicial: date, data_final: date) -> list[dict[str, Any]]:
    itens_qs = (
...
def _build_performance_section(unidade_id: int, data_inicial: date, data_final: date) -> dict[str, Any]:
    ...
    nao_realizadas_grupos = _build_non_performed_groups(unidade_id, data_inicial, data_final)
