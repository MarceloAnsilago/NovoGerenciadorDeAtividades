...
# Database (Supabase via pgBouncer transaction pooler)
# Observações:
# - sslmode=require é necessário no Supabase
# - CONN_MAX_AGE=0 para pgBouncer em modo transaction
# - DISABLE_SERVER_SIDE_CURSORS=True para evitar problemas com o pooler
DATABASES = {
    "default": {
...
# (Opcional) Segurança extra em prod
if not DEBUG:
